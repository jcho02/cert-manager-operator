...
#  - bundle/cert-manager-operator.catalogsource.yaml
#  - bundle/cert-manager-operator.operator-group.yaml
#  - bundle/cert-manager-operator.subscription.yaml
...
export TAG=${TAG:-'1.12.4'}
export CATALOG_PATH=${CATALOG_PATH:-'./bundle/cert-manager-operator.catalogsource.yaml'}
export CATALOG_IMAGE=${CATALOG_IMAGE:-"${CATALOG_IMAGE}:${TAG}"}
export OG_PATH=${OG_PATH:-'./bundle/cert-manager-operator.operatorgroup.yaml'}
export SUBSCRIPTION_PATH=${SUBSCRIPTION_PATH:-'./bundle/cert-manager-operator.subscription.yaml'}
export OPERATOR_PKG_NAME=${OPERATOR_PKG_NAME:-'cert-manager-operator'}
